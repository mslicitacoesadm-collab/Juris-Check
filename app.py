...
st.set_page_config(page_title='Atlas dos Acórdãos V15', page_icon='⚖️', layout='wide')
...
with c_hero:
    st.markdown(
        """
        <div class="hero">
          <h1>Atlas dos Acórdãos · V15 Base Inteligente</h1>
...
if summary.get('base_inteligente_detectada'):
    st.success(f"Base inteligente ativa: {summary.get('arquivo_base_inteligente')} — o motor agora prioriza tese central, utilidade prática e contexto licitatório.")
else:
